...
HD_PWD='C:/Users/aaron/Desktop/git_article/RTL/bestAlgorithm_RTL/bestAlgorithm_RTL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bubbleSort.vds -m64 -mode batch -messageDb vivado.pb -notrace -source bubbleSort.tcl
