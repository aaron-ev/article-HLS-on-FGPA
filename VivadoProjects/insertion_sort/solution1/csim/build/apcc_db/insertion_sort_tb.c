...
void insertion_sort(float *, signed int );
...
static  char aesl_internal_str[24] = "Se ha creado el archivo";
...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @data_load(float* getelementptr inbounds ([48 x float]* @A, i64 0, i64 0)), !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_1_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @insertion_sort(float* getelementptr inbounds ([48 x float]* @A, i64 0, i64 0), i32 48) nounwind, !dbg !3 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_2_count);
   /*tail*/ insertion_sort((float *)((&A[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 48
#endif
])), 48u);
...
llvm_cbe_tmp__13:
if (AESL_DEBUG_TRACE)
printf("\n  %%puts = tail call i32 @puts(i8* getelementptr inbounds ([24 x i8]* @aesl_internal_str, i64 0, i64 0)), !dbg !5 for 0x%I64xth hint within @data_load  --> \n", ++aesl_llvm_cbe_puts_count);
...
llvm_cbe_tmp__14:
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge1 = phi i32 [ 0, %%5 ], [ %%14, %%6  for 0x%I64xth hint within @data_load  --> \n", ++aesl_llvm_cbe_storemerge1_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = tail call i32 @rand() nounwind, !dbg !3 for 0x%I64xth hint within @data_load  --> \n", ++aesl_llvm_cbe_24_count);
  llvm_cbe_tmp__3 = (unsigned int ) /*tail*/ rand();
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__3);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = srem i32 %%7, 100, !dbg !3 for 0x%I64xth hint within @data_load  --> \n", ++aesl_llvm_cbe_25_count);
  llvm_cbe_tmp__4 = (unsigned int )((signed int )(((signed int )llvm_cbe_tmp__3) % ((signed int )100u)));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((signed int )llvm_cbe_tmp__4));
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = sitofp i32 %%8 to float, !dbg !3 for 0x%I64xth hint within @data_load  --> \n", ++aesl_llvm_cbe_26_count);
  llvm_cbe_tmp__5 = (float )((float )(signed int )llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
...
printf("\n = 0x%I64X\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  %%11 = getelementptr inbounds float* %%A, i64 %%10, !dbg !3 for 0x%I64xth hint within @data_load  --> \n", ++aesl_llvm_cbe_28_count);
  llvm_cbe_tmp__7 = (float *)(&llvm_cbe_A[(((signed long long )llvm_cbe_tmp__6))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__6));
}
if (AESL_DEBUG_TRACE)
printf("\n  store float %%9, float* %%11, align 4, !dbg !3 for 0x%I64xth hint within @data_load  --> \n", ++aesl_llvm_cbe_29_count);
  *llvm_cbe_tmp__7 = llvm_cbe_tmp__5;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = fpext float %%9 to double, !dbg !3 for 0x%I64xth hint within @data_load  --> \n", ++aesl_llvm_cbe_30_count);
  llvm_cbe_tmp__8 = (double )((double )llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__8, *(long long*)(&llvm_cbe_tmp__8));
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = tail call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%1, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str4, i64 0, i64 0), double %%12) nounwind, !dbg !3 for 0x%I64xth hint within @data_load  --> \n", ++aesl_llvm_cbe_31_count);
...
llvm_cbe_tmp__15:
if (AESL_DEBUG_TRACE)
printf("\n  %%16 = tail call i32 @fclose(%%struct._iobuf* %%1) nounwind, !dbg !5 for 0x%I64xth hint within @data_load  --> \n", ++aesl_llvm_cbe_39_count);
...
printf("\n  %%1 = tail call %%struct._iobuf* @fopen(i8* getelementptr inbounds ([13 x i8]* @aesl_internal_.str, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str5, i64 0, i64 0)) nounwind, !dbg !3 for 0x%I64xth hint within @data_unload  --> \n", ++aesl_llvm_cbe_43_count);
  llvm_cbe_tmp__16 = (l_struct_OC__iobuf *) /*tail*/ aesl_fopen(( char *)((&aesl_internal__OC_str[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 13
#endif
...
printf("\n  %%2 = tail call i64 @fwrite(i8* getelementptr inbounds ([14 x i8]* @aesl_internal_.str6, i64 0, i64 0), i64 13, i64 1, %%struct._iobuf* %%1), !dbg !5 for 0x%I64xth hint within @data_unload  --> \n", ++aesl_llvm_cbe_48_count);
 ...
 % 14
#endif
])), 13ull, 1ull, (l_struct_OC__iobuf *)llvm_cbe_tmp__16);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = sext i32 %%storemerge1 to i64, !dbg !3 for 0x%I64xth hint within @data_unload  --> \n", ++aesl_llvm_cbe_54_count);
  llvm_cbe_tmp__18 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge1);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = getelementptr inbounds float* %%A, i64 %%4, !dbg !3 for 0x%I64xth hint within @data_unload  --> \n", ++aesl_llvm_cbe_55_count);
  llvm_cbe_tmp__19 = (float *)(&llvm_cbe_A[(((signed long long )llvm_cbe_tmp__18))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__18));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = load float* %%5, align 4, !dbg !3 for 0x%I64xth hint within @data_unload  --> \n", ++aesl_llvm_cbe_56_count);
  llvm_cbe_tmp__20 = (float )*llvm_cbe_tmp__19;
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__20, *(int*)(&llvm_cbe_tmp__20));
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = fpext float %%6 to double, !dbg !3 for 0x%I64xth hint within @data_unload  --> \n", ++aesl_llvm_cbe_57_count);
  llvm_cbe_tmp__21 = (double )((double )llvm_cbe_tmp__20);
if (AESL_DEBUG_TRACE)
printf("\n = %lf,  0x%llx\n", llvm_cbe_tmp__21, *(long long*)(&llvm_cbe_tmp__21));
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = tail call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%1, i8* getelementptr inbounds ([4 x i8]* @aesl_internal_.str4, i64 0, i64 0), double %%7) nounwind, !dbg !3 for 0x%I64xth hint within @data_unload  --> \n", ++aesl_llvm_cbe_58_count);
   /*tail*/ fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__16, ( char *)((&aesl_internal__OC_str4[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 4
#endif
])), llvm_cbe_tmp__21);
...
printf("\n  %%9 = add nsw i32 %%storemerge1, 1, !dbg !5 for 0x%I64xth hint within @data_unload  --> \n", ++aesl_llvm_cbe_59_count);
  llvm_cbe_tmp__23 = (unsigned int )((unsigned int )(llvm_cbe_storemerge1&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__23&4294967295ull)));
  if (((llvm_cbe_tmp__23&4294967295U) == (48u&4294967295U))) {
