...
void insertion_sort(float *llvm_cbe_A, signed int llvm_cbe_sizeA);
...
printf("\n\{ BEGIN @insertion_sort\n");
  if ((((unsigned int )llvm_cbe_sizeA&4294967295U) > ((unsigned int )1u&4294967295U))) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge5 = phi i32 [ %%13, %%._crit_edge ], [ 1, %%0  for 0x%I64xth hint within @insertion_sort  --> \n", ++aesl_llvm_cbe_storemerge5_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%13 = add nsw i32 %%storemerge5, 1, !dbg !4 for 0x%I64xth hint within @insertion_sort  --> \n", ++aesl_llvm_cbe_34_count);
  llvm_cbe_tmp__7 = (unsigned int )((unsigned int )(llvm_cbe_storemerge5&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__7&4294967295ull)));
  if (((llvm_cbe_tmp__7&4294967295U) == (llvm_cbe_sizeA&4294967295U))) {
    goto llvm_cbe__2e__crit_edge6;
  } else {
    llvm_cbe_storemerge5__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__7;   /* for PHI node */
    goto llvm_cbe__2e_preheader;
  }
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge14.in = phi i32 [ %%storemerge14, %%11 ], [ %%storemerge5, %%.preheader  for 0x%I64xth hint within @insertion_sort  --> \n", ++aesl_llvm_cbe_storemerge14_2e_in_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge14 = add nsw i32 %%storemerge14.in, -1, !dbg !4 for 0x%I64xth hint within @insertion_sort  --> \n", ++aesl_llvm_cbe_storemerge14_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = sext i32 %%storemerge14 to i64, !dbg !2 for 0x%I64xth hint within @insertion_sort  --> \n", ++aesl_llvm_cbe_19_count);
  llvm_cbe_tmp__1 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge14);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__1);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = getelementptr inbounds float* %%A, i64 %%3, !dbg !2 for 0x%I64xth hint within @insertion_sort  --> \n", ++aesl_llvm_cbe_20_count);
  llvm_cbe_tmp__2 = (float *)(&llvm_cbe_A[(((signed long long )llvm_cbe_tmp__1))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__1));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = load float* %%4, align 4, !dbg !2 for 0x%I64xth hint within @insertion_sort  --> \n", ++aesl_llvm_cbe_21_count);
  llvm_cbe_tmp__3 = (float )*llvm_cbe_tmp__2;
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__3, *(int*)(&llvm_cbe_tmp__3));
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = sext i32 %%storemerge14.in to i64, !dbg !2 for 0x%I64xth hint within @insertion_sort  --> \n", ++aesl_llvm_cbe_22_count);
  llvm_cbe_tmp__4 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge14_2e_in);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__4);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds float* %%A, i64 %%6, !dbg !2 for 0x%I64xth hint within @insertion_sort  --> \n", ++aesl_llvm_cbe_23_count);
  llvm_cbe_tmp__5 = (float *)(&llvm_cbe_A[(((signed long long )llvm_cbe_tmp__4))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__4));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = load float* %%7, align 4, !dbg !2 for 0x%I64xth hint within @insertion_sort  --> \n", ++aesl_llvm_cbe_24_count);
  llvm_cbe_tmp__6 = (float )*llvm_cbe_tmp__5;
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__6, *(int*)(&llvm_cbe_tmp__6));
  if ((llvm_fcmp_ogt(llvm_cbe_tmp__3, llvm_cbe_tmp__6))) {
...
llvm_cbe_tmp__8:
if (AESL_DEBUG_TRACE)
printf("\n  store float %%8, float* %%4, align 4, !dbg !3 for 0x%I64xth hint within @insertion_sort  --> \n", ++aesl_llvm_cbe_29_count);
  *llvm_cbe_tmp__2 = llvm_cbe_tmp__6;
if (AESL_DEBUG_TRACE)
printf("\n = %f\n", llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE)
printf("\n  store float %%5, float* %%7, align 4, !dbg !3 for 0x%I64xth hint within @insertion_sort  --> \n", ++aesl_llvm_cbe_30_count);
