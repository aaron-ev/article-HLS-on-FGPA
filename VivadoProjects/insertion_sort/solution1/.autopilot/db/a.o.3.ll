...
codeRepl:
  ...
  call void @llvm.dbg.value(metadata !{i8 %posOutData_read}, i64 0, metadata !25), !dbg !456 ; [debug line = 25:46] [debug variable = posOutData]
  %dataIn_read = call i16 @_ssdm_op_Read.ap_auto.i16(i16 %dataIn) ; [#uses=1 type=i16]
  call void @llvm.dbg.value(metadata !{i16 %dataIn_read}, i64 0, metadata !457), !dbg !458 ; [debug line = 25:34] [debug variable = dataIn]
  ...
  call void @llvm.dbg.value(metadata !{i16 %dataIn}, i64 0, metadata !457), !dbg !458 ; [debug line = 25:34] [debug variable = dataIn]
  call void @llvm.dbg.value(metadata !{i8 %posOutData}, i64 0, metadata !25), !dbg !456 ; [debug line = 25:46] [debug variable = posOutData]
  %count_load = load i16* @count, align 2, !dbg !475 ; [#uses=3 type=i16] [debug line = 33:2]
  %tmp = call i8 @_ssdm_op_PartSelect.i8.i16.i32.i32(i16 %count_load, i32 8, i32 15), !dbg !475 ; [#uses=1 type=i8] [debug line = 33:2]
  %icmp = icmp slt i8 %tmp, 1, !dbg !475          ; [#uses=1 type=i1] [debug line = 33:2]
  %sOutData_done_V_load = load i1* @sOutData_done_V, align 1, !dbg !477 ; [#uses=2 type=i1] [debug line = 37:3]
  br i1 %icmp, label %0, label %1, !dbg !475      ; [debug line = 33:2]

; <label>:0                                       ; preds = %codeRepl
  %tmp_1 = sext i16 %count_load to i64, !dbg !479 ; [#uses=1 type=i64] [debug line = 35:3]
  %A_addr = getelementptr inbounds [256 x i16]* @A, i64 0, i64 %tmp_1, !dbg !479 ; [#uses=1 type=i16*] [debug line = 35:3]
  store i16 %dataIn_read, i16* %A_addr, align 2, !dbg !479 ; [debug line = 35:3]
  %tmp_2 = add i16 %count_load, 1, !dbg !480      ; [#uses=1 type=i16] [debug line = 36:3]
  store i16 %tmp_2, i16* @count, align 2, !dbg !480 ; [debug line = 36:3]
  %sOutData_data_load = load i16* @sOutData_data, align 2, !dbg !477 ; [#uses=1 type=i16] [debug line = 37:3]
  br label %5, !dbg !477                          ; [debug line = 37:3]

; <label>:1                                       ; preds = %codeRepl
  %flagFill_load = load i1* @flagFill, align 1    ; [#uses=1 type=i1]
  br i1 %flagFill_load, label %._crit_edge7, label %.preheader, !dbg !481 ; [debug line = 41:3]

.preheader:                                       ; preds = %4, %1
  %i_i = phi i9 [ %i, %4 ], [ 1, %1 ]             ; [#uses=3 type=i9]
  %exitcond_i = icmp eq i9 %i_i, -256, !dbg !483  ; [#uses=1 type=i1] [debug line = 7:10@44:20]
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 255, i64 255, i64 255) ; [#uses=0 type=i32]
  br i1 %exitcond_i, label %insertionAlgorithm.exit, label %.preheader.i, !dbg !483 ; [debug line = 7:10@44:20]

.preheader.i:                                     ; preds = %._crit_edge.i, %.preheader
  %j_0_in_i = phi i9 [ %j, %._crit_edge.i ], [ %i_i, %.preheader ] ; [#uses=3 type=i9]
  %j_0_in_i_cast = sext i9 %j_0_in_i to i32, !dbg !492 ; [#uses=1 type=i32] [debug line = 9:13@44:20]
  %j = add i9 %j_0_in_i, -1, !dbg !492            ; [#uses=2 type=i9] [debug line = 9:13@44:20]
  %j_cast = sext i9 %j to i32, !dbg !492          ; [#uses=1 type=i32] [debug line = 9:13@44:20]
  call void @llvm.dbg.value(metadata !{i9 %j}, i64 0, metadata !495), !dbg !492 ; [debug line = 9:13@44:20] [debug variable = j]
  %tmp_i = icmp sgt i9 %j_0_in_i, 0, !dbg !492    ; [#uses=1 type=i1] [debug line = 9:13@44:20]
  %empty_4 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 1, i64 255, i64 0) ; [#uses=0 type=i32]
  br i1 %tmp_i, label %2, label %4, !dbg !492     ; [debug line = 9:13@44:20]

; <label>:2                                       ; preds = %.preheader.i
  %tmp_5_i = zext i32 %j_cast to i64, !dbg !496   ; [#uses=1 type=i64] [debug line = 11:13@44:20]
  %A_addr_1 = getelementptr [256 x i16]* @A, i64 0, i64 %tmp_5_i, !dbg !496 ; [#uses=2 type=i16*] [debug line = 11:13@44:20]
  %temp = load i16* %A_addr_1, align 2, !dbg !496 ; [#uses=2 type=i16] [debug line = 11:13@44:20]
  %tmp_6_i = zext i32 %j_0_in_i_cast to i64, !dbg !496 ; [#uses=1 type=i64] [debug line = 11:13@44:20]
  %A_addr_2 = getelementptr [256 x i16]* @A, i64 0, i64 %tmp_6_i, !dbg !496 ; [#uses=2 type=i16*] [debug line = 11:13@44:20]
  %A_load_1 = load i16* %A_addr_2, align 2, !dbg !496 ; [#uses=2 type=i16] [debug line = 11:13@44:20]
  %tmp_7_i = icmp sgt i16 %temp, %A_load_1, !dbg !496 ; [#uses=1 type=i1] [debug line = 11:13@44:20]
  br i1 %tmp_7_i, label %3, label %._crit_edge.i, !dbg !496 ; [debug line = 11:13@44:20]

; <label>:3                                       ; preds = %2
  call void @llvm.dbg.value(metadata !{i16 %temp}, i64 0, metadata !498), !dbg !500 ; [debug line = 14:34@44:20] [debug variable = temp]
  store i16 %A_load_1, i16* %A_addr_1, align 2, !dbg !501 ; [debug line = 15:17@44:20]
  store i16 %temp, i16* %A_addr_2, align 2, !dbg !502 ; [debug line = 16:17@44:20]
  br label %._crit_edge.i, !dbg !503              ; [debug line = 17:13@44:20]

._crit_edge.i:                                    ; preds = %3, %2
  br label %.preheader.i, !dbg !504               ; [debug line = 9:30@44:20]

; <label>:4                                       ; preds = %.preheader.i
  %i = add i9 %i_i, 1, !dbg !505                  ; [#uses=1 type=i9] [debug line = 7:59@44:20]
  call void @llvm.dbg.value(metadata !{i9 %i}, i64 0, metadata !506), !dbg !505 ; [debug line = 7:59@44:20] [debug variable = i]
  br label %.preheader, !dbg !505                 ; [debug line = 7:59@44:20]

insertionAlgorithm.exit:                          ; preds = %.preheader
  store i1 true, i1* @sOutData_done_V, align 2, !dbg !507 ; [debug line = 382:9@44:20]
  store i1 true, i1* @flagFill, align 1, !dbg !510 ; [debug line = 45:4]
  br label %._crit_edge7, !dbg !511               ; [debug line = 46:3]

._crit_edge7:                                     ; preds = %insertionAlgorithm.exit, %1
  %sOutData_done_V_loc = phi i1 [ true, %insertionAlgorithm.exit ], [ %sOutData_done_V_load, %1 ] ; [#uses=1 type=i1]
  ...
  %A_load = load i16* %A_addr_3, align 2          ; [#uses=2 type=i16]
  store i16 %A_load, i16* @sOutData_data, align 2, !dbg !512 ; [debug line = 48:2]
  br label %5, !dbg !513                          ; [debug line = 50:2]

; <label>:5                                       ; preds = %._crit_edge7, %0
  %storemerge1 = phi i16 [ %A_load, %._crit_edge7 ], [ %sOutData_data_load, %0 ] ; [#uses=1 type=i16]
  %storemerge = phi i1 [ %sOutData_done_V_loc, %._crit_edge7 ], [ %sOutData_done_V_load, %0 ] ; [#uses=1 type=i1]
  call void @_ssdm_op_Write.ap_auto.i16P(i16* %agg_result_data, i16 %storemerge1), !dbg !477 ; [debug line = 37:3]
  call void @_ssdm_op_Write.ap_auto.i1P(i1* %agg_result_done_V, i1 %storemerge), !dbg !477 ; [debug line = 37:3]
  ret void, !dbg !514                             ; [debug line = 51:1]
}
...
!25 = metadata !{i32 786689, metadata !26, metadata !"posOutData", metadata !27, i32 33554457, metadata !119, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!26 = metadata !{i32 786478, i32 0, metadata !27, metadata !"insertionSort", metadata !"insertionSort", metadata !"_Z13insertionSortsc", metadata !27, i32 25, metadata !28, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !56, i32 26} ; [ DW_TAG_subprogram ]
!27 = metadata !{i32 786473, metadata !"insertion_sort.cpp", metadata !"C:\5CUsers\5Caaron\5CDesktop\5Cgit_article\5CvivadoProjects", null} ; [ DW_TAG_file_type ]
...
!30 = metadata !{i32 786454, null, metadata !"outData_s", metadata !27, i32 20, i64 0, i64 0, i64 0, i32 0, metadata !31} ; [ DW_TAG_typedef ]
!31 = metadata !{i32 786434, null, metadata !"", metadata !32, i32 16, i64 32, i64 16, i32 0, i32 0, null, metadata !33, i32 0, null, null} ; [ DW_TAG_class_type ]
!32 = metadata !{i32 786473, metadata !"./insertion_sort.h", metadata !"C:\5CUsers\5Caaron\5CDesktop\5Cgit_article\5CvivadoProjects", null} ; [ DW_TAG_file_type ]
!33 = metadata !{metadata !34, metadata !37, metadata !450}
!34 = metadata !{i32 786445, metadata !31, metadata !"data", metadata !32, i32 18, i64 16, i64 16, i64 0, i32 0, metadata !35} ; [ DW_TAG_member ]
!35 = metadata !{i32 786454, null, metadata !"data_inp", metadata !27, i32 14, i64 0, i64 0, i64 0, i32 0, metadata !36} ; [ DW_TAG_typedef ]
!36 = metadata !{i32 786468, null, metadata !"short", null, i32 0, i64 16, i64 16, i64 0, i32 0, i32 5} ; [ DW_TAG_base_type ]
!37 = metadata !{i32 786445, metadata !31, metadata !"done", metadata !32, i32 19, i64 8, i64 8, i64 16, i32 0, metadata !38} ; [ DW_TAG_member ]
!38 = metadata !{i32 786454, null, metadata !"fp_bit1", metadata !27, i32 12, i64 0, i64 0, i64 0, i32 0, metadata !39} ; [ DW_TAG_typedef ]
...
!450 = metadata !{i32 786478, i32 0, metadata !31, metadata !"", metadata !"", metadata !"", metadata !32, i32 16, metadata !451, i1 false, i1 false, i32 0, i32 0, null, i32 320, i1 false, null, null, i32 0, metadata !56, i32 16} ; [ DW_TAG_subprogram ]
...
!456 = metadata !{i32 25, i32 46, metadata !26, null}
!457 = metadata !{i32 786689, metadata !26, metadata !"dataIn", metadata !27, i32 16777241, metadata !35, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!458 = metadata !{i32 25, i32 34, metadata !26, null}
!459 = metadata !{i32 790530, metadata !460, metadata !"agg.result.data", null, i32 25, metadata !462, i32 0, i32 0} ; [ DW_TAG_return_variable_field ]
!460 = metadata !{i32 786690, metadata !26, metadata !"agg.result", metadata !27, i32 25, metadata !461, i32 0, i32 0} ; [ DW_TAG_return_variable ]
...
!463 = metadata !{i32 786438, null, metadata !"", metadata !32, i32 16, i64 16, i64 16, i32 0, i32 0, null, metadata !464, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!464 = metadata !{metadata !34}
!465 = metadata !{i32 790530, metadata !460, metadata !"agg.result.done.V", null, i32 25, metadata !466, i32 0, i32 0} ; [ DW_TAG_return_variable_field ]
!466 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !467} ; [ DW_TAG_pointer_type ]
!467 = metadata !{i32 786438, null, metadata !"", metadata !32, i32 16, i64 1, i64 16, i32 0, i32 0, null, metadata !468, i32 0, null, null} ; [ DW_TAG_class_field_type ]
...
!475 = metadata !{i32 33, i32 2, metadata !476, null}
!476 = metadata !{i32 786443, metadata !26, i32 26, i32 1, metadata !27, i32 6} ; [ DW_TAG_lexical_block ]
!477 = metadata !{i32 37, i32 3, metadata !478, null}
!478 = metadata !{i32 786443, metadata !476, i32 34, i32 2, metadata !27, i32 7} ; [ DW_TAG_lexical_block ]
!479 = metadata !{i32 35, i32 3, metadata !478, null}
!480 = metadata !{i32 36, i32 3, metadata !478, null}
!481 = metadata !{i32 41, i32 3, metadata !482, null}
!482 = metadata !{i32 786443, metadata !476, i32 40, i32 2, metadata !27, i32 8} ; [ DW_TAG_lexical_block ]
!483 = metadata !{i32 7, i32 10, metadata !484, metadata !490}
!484 = metadata !{i32 786443, metadata !485, i32 7, i32 6, metadata !27, i32 1} ; [ DW_TAG_lexical_block ]
!485 = metadata !{i32 786443, metadata !486, i32 4, i32 2, metadata !27, i32 0} ; [ DW_TAG_lexical_block ]
!486 = metadata !{i32 786478, i32 0, metadata !27, metadata !"insertionAlgorithm", metadata !"insertionAlgorithm", metadata !"_Z18insertionAlgorithmPs", metadata !27, i32 3, metadata !487, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !56, i32 4} ; [ DW_TAG_subprogram ]
...
!490 = metadata !{i32 44, i32 20, metadata !491, null}
!491 = metadata !{i32 786443, metadata !482, i32 42, i32 3, metadata !27, i32 9} ; [ DW_TAG_lexical_block ]
!492 = metadata !{i32 9, i32 13, metadata !493, metadata !490}
!493 = metadata !{i32 786443, metadata !494, i32 9, i32 9, metadata !27, i32 3} ; [ DW_TAG_lexical_block ]
!494 = metadata !{i32 786443, metadata !484, i32 8, i32 6, metadata !27, i32 2} ; [ DW_TAG_lexical_block ]
!495 = metadata !{i32 786688, metadata !485, metadata !"j", metadata !27, i32 5, metadata !65, i32 0, metadata !490} ; [ DW_TAG_auto_variable ]
!496 = metadata !{i32 11, i32 13, metadata !497, metadata !490}
!497 = metadata !{i32 786443, metadata !493, i32 10, i32 9, metadata !27, i32 4} ; [ DW_TAG_lexical_block ]
!498 = metadata !{i32 786688, metadata !499, metadata !"temp", metadata !27, i32 14, metadata !35, i32 0, metadata !490} ; [ DW_TAG_auto_variable ]
!499 = metadata !{i32 786443, metadata !497, i32 12, i32 13, metadata !27, i32 5} ; [ DW_TAG_lexical_block ]
!500 = metadata !{i32 14, i32 34, metadata !499, metadata !490}
!501 = metadata !{i32 15, i32 17, metadata !499, metadata !490}
!502 = metadata !{i32 16, i32 17, metadata !499, metadata !490}
!503 = metadata !{i32 17, i32 13, metadata !499, metadata !490}
!504 = metadata !{i32 9, i32 30, metadata !493, metadata !490}
!505 = metadata !{i32 7, i32 59, metadata !484, metadata !490}
!506 = metadata !{i32 786688, metadata !485, metadata !"i", metadata !27, i32 5, metadata !65, i32 0, metadata !490} ; [ DW_TAG_auto_variable ]
!507 = metadata !{i32 382, i32 9, metadata !508, metadata !490}
!508 = metadata !{i32 786443, metadata !509, i32 381, i32 53, metadata !40, i32 10} ; [ DW_TAG_lexical_block ]
!509 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZN8ap_fixedILi1ELi0EL9ap_q_mode5EL9ap_o_mode3ELi0EEaSERKS2_", metadata !40, i32 380, metadata !435, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !434, metadata !56, i32 381} ; [ DW_TAG_subprogram ]
!510 = metadata !{i32 45, i32 4, metadata !491, null}
!511 = metadata !{i32 46, i32 3, metadata !491, null}
!512 = metadata !{i32 48, i32 2, metadata !476, null}
!513 = metadata !{i32 50, i32 2, metadata !476, null}
!514 = metadata !{i32 51, i32 1, metadata !476, null}
