...
void bubbleSort(float *llvm_cbe_A);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = fptosi float %%3 to i32, !dbg !2 for 0x%I64xth hint within @swap  --> \n", ++aesl_llvm_cbe_15_count);
...
if (AESL_DEBUG_TRACE)
printf("\n\{ BEGIN @bubbleSort\n");
  llvm_cbe_indvars_2e_iv__PHI_TEMPORARY = (unsigned int )47u;   /* for PHI node */
  goto llvm_cbe__2e_preheader;

  do {     /* Syntactic loop '.preheader' to make GCC happy */
llvm_cbe__2e_preheader:
if (AESL_DEBUG_TRACE)
printf("\n  %%indvars.iv = phi i32 [ 47, %%0 ], [ %%indvars.iv.next, %%._crit_edge  for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_indvars_2e_iv_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%indvars.iv.next = add i32 %%indvars.iv, -1, !dbg !3 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_indvars_2e_iv_2e_next_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge12 = phi i32 [ %%5, %%11 ], [ 0, %%.preheader  for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_storemerge12_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = sext i32 %%storemerge12 to i64, !dbg !2 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_42_count);
  llvm_cbe_tmp__9 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge12);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = getelementptr inbounds float* %%A, i64 %%2, !dbg !2 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_43_count);
  llvm_cbe_tmp__10 = (float *)(&llvm_cbe_A[(((signed long long )llvm_cbe_tmp__9))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__9));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = load float* %%3, align 4, !dbg !2 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_44_count);
  llvm_cbe_tmp__11 = (float )*llvm_cbe_tmp__10;
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__11, *(int*)(&llvm_cbe_tmp__11));
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = add nsw i32 %%storemerge12, 1, !dbg !2 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_45_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = sext i32 %%5 to i64, !dbg !2 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_46_count);
  llvm_cbe_tmp__13 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__13);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = getelementptr inbounds float* %%A, i64 %%6, !dbg !2 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_47_count);
  llvm_cbe_tmp__14 = (float *)(&llvm_cbe_A[(((signed long long )llvm_cbe_tmp__13))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__13));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = load float* %%7, align 4, !dbg !2 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_48_count);
  llvm_cbe_tmp__15 = (float )*llvm_cbe_tmp__14;
if (AESL_DEBUG_TRACE)
printf("\n = %f,  0x%x\n", llvm_cbe_tmp__15, *(int*)(&llvm_cbe_tmp__15));
  if ((llvm_fcmp_ogt(llvm_cbe_tmp__11, llvm_cbe_tmp__15))) {
...
llvm_cbe_tmp__17:
  if (((llvm_cbe_tmp__12&4294967295U) == (llvm_cbe_indvars_2e_iv&4294967295U))) {
...
llvm_cbe_tmp__16:
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @swap(float* %%A, i32 %%storemerge12, i32 %%5), !dbg !3 for 0x%I64xth hint within @bubbleSort  --> \n", ++aesl_llvm_cbe_51_count);
   /*tail*/ swap((float *)llvm_cbe_A, llvm_cbe_storemerge12, llvm_cbe_tmp__12);
if (AESL_DEBUG_TRACE) {
