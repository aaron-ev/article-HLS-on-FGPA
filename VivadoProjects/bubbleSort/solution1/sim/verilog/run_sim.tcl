...
if {[file isfile bubbleSort.autotvin.dat]} {
	file delete -force bubbleSort.autotvin.dat
}

if {[file isfile bubbleSort.autotvout.dat]} {
	file delete -force bubbleSort.autotvout.dat
}
