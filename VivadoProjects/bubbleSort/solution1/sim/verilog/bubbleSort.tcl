...
add_wave /apatb_bubbleSort_top/AESL_inst_bubbleSort/posOutData -into $posOutData_group -radix hex
set dataIn_group [add_wave_group dataIn(wire) -into $cinputgroup]
add_wave /apatb_bubbleSort_top/AESL_inst_bubbleSort/dataIn -into $dataIn_group -radix hex
...
add_wave /apatb_bubbleSort_top/LENGTH_dataIn -into $tb_portdepth_group -radix hex
add_wave /apatb_bubbleSort_top/LENGTH_posOutData -into $tb_portdepth_group -radix hex
...
add_wave /apatb_bubbleSort_top/posOutData -into $tb_posOutData_group -radix hex
set tb_dataIn_group [add_wave_group dataIn(wire) -into $tbcinputgroup]
add_wave /apatb_bubbleSort_top/dataIn -into $tb_dataIn_group -radix hex
