set C_TypeInfoList {{ 
"bubbleSort" : [[], {"return": [[],"0"] }, [{"ExternC" : 0}], [ {"indexOutputData": [[], {"scalar": "char"}] }],["1","2"],""],
 "1": [ "operation", [[],"3"],""],
 "2": [ "A", [[], {"array": ["0", [16]]}],""], 
...
set C_modelArgList {
	...
	{ A int 16 regular {array 16 { 2 2 } 1 1 } {global 2}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "indexOutputData", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "indexOutputData","cData": "char","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}]} , 
 	...
 	{ "Name" : "A", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE", "bitSlice":[{"low":0,"up":15,"cElement": [{"cName": "A","cData": "short","bit_use": { "low": 0,"up": 15},"cArray": [{"low" : 0,"up" : 15,"step" : 1}]}]}], "extern" : 1} , 
...
set portList { 
	...
	{ A_address1 sc_out sc_lv 4 signal 2 } 
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "3", "Max" : "515"}
]}

set Spec2ImplPortList { 
	indexOutputData { ap_none {  { indexOutputData in_data 0 8 } } }
	operation_V { ap_none {  { operation_V in_data 0 1 } } }
	A { ap_memory {  { A_address0 mem_address 1 4 }  { A_ce0 mem_ce 1 1 }  { A_we0 mem_we 1 1 }  { A_d0 mem_din 1 16 }  { A_q0 mem_dout 0 16 }  { A_address1 mem_address 1 4 }  { A_ce1 mem_ce 1 1 }  { A_we1 mem_we 1 1 }  { A_d1 mem_din 1 16 }  { A_q1 mem_dout 0 16 } } }
}
