set C_TypeInfoList {{ 
"bubbleSort" : [[], {"return": [[],"0"] }, [{"ExternC" : 0}], [ {"dataIn": [[],"0"] }, {"posOutData": [[], {"scalar": "char"}] }],[],""], 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"], "CDFG" : "bubbleSort", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "131075"}
	, {"Name" : "Interval", "Min" : "2", "Max" : "131076"}
]}
