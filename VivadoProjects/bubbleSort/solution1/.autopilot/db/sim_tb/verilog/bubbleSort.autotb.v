...
`define AUTOTB_DUT      bubbleSort
`define AUTOTB_DUT_INST AESL_inst_bubbleSort
`define AUTOTB_TOP      apatb_bubbleSort_top
`define AUTOTB_LAT_RESULT_FILE "bubbleSort.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "bubbleSort.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_bubbleSort_top
...
`define AUTOTB_TVIN_A  "./c.bubbleSort.autotvin_A.dat"
`define AUTOTB_TVIN_indexOutputData  "./c.bubbleSort.autotvin_indexOutputData.dat"
`define AUTOTB_TVIN_operation  "./c.bubbleSort.autotvin_operation.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.bubbleSort.autotvin_A.dat"
`define AUTOTB_TVIN_indexOutputData_out_wrapc  "./rtl.bubbleSort.autotvin_indexOutputData.dat"
`define AUTOTB_TVIN_operation_out_wrapc  "./rtl.bubbleSort.autotvin_operation.dat"
`define AUTOTB_TVOUT_A  "./c.bubbleSort.autotvout_A.dat"
`define AUTOTB_TVOUT_ap_return  "./c.bubbleSort.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_A_out_wrapc  "./impl_rtl.bubbleSort.autotvout_A.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.bubbleSort.autotvout_ap_return.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.bubbleSort.autotvout_A.dat", "r");
    fp2 = $fopen("./impl_rtl.bubbleSort.autotvout_A.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.bubbleSort.autotvout_A.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.bubbleSort.autotvout_A.dat\"!");
    else begin
        $display("Comparing rtl.bubbleSort.autotvout_A.dat with impl_rtl.bubbleSort.autotvout_A.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.bubbleSort.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.bubbleSort.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.bubbleSort.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.bubbleSort.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.bubbleSort.autotvout_ap_return.dat with impl_rtl.bubbleSort.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
