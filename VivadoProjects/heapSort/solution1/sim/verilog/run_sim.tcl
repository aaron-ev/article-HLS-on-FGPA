...
if {[file isfile heapSort.autotvin.dat]} {
	file delete -force heapSort.autotvin.dat
}

if {[file isfile heapSort.autotvout.dat]} {
	file delete -force heapSort.autotvout.dat
}
