...
signed short heapSort(signed short ,  char );
...
printf("\n = 0x%X\n", llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = tail call signext i16 @heapSort(i16 signext %%3, i8 signext 0) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_10_count);
   /*tail*/ heapSort(llvm_cbe_tmp__2, ((unsigned char )0));
if (AESL_DEBUG_TRACE) {
...
printf("\n = 0x%X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = tail call signext i16 @heapSort(i16 signext 0, i8 signext %%6) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_20_count);
   /*tail*/ heapSort(((unsigned short )0), llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE) {
