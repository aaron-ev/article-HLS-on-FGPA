...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "heapSort.autotvin.dat"
	set constFileTvOut       "heapSort.autotvout.dat"
	set constFileHdlTvIn     "heapSort.autohdltvin.dat"
	set constFileHdlTvOut    "heapSort.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
