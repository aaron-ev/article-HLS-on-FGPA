set moduleName heapSort_noRecurv_maxHeapify_noRecurv
...
set isOneStateSeq 0
set C_modelName {heapSort_noRecurv_maxHeapify_noRecurv}
set C_modelType { void 0 }
set C_modelArgList {
	{ A float 32 regular {array 48 { 2 2 } 1 1 }  }
	{ startA int 6 regular  }
	{ endA int 7 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "A", "interface" : "memory", "bitwidth" : 32, "direction" : "READWRITE"} , 
 	{ "Name" : "startA", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "endA", "interface" : "wire", "bitwidth" : 7, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ startA sc_in sc_lv 6 signal 1 } 
	{ endA sc_in sc_lv 7 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "startA", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "startA", "role": "default" }} , 
 	{ "name": "endA", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "endA", "role": "default" }}  ]}

set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2"], "CDFG" : "heapSort_noRecurv_maxHeapify_noRecurv", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		...
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.heapSort_noRecurv_sitofp_32ns_32_6_U0", "Parent" : "0", "Child" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.heapSort_noRecurv_fcmp_32ns_32ns_1_1_U1", "Parent" : "0", "Child" : []}]}
...
set Spec2ImplPortList { 
	...
	startA { ap_none {  { startA in_data 0 6 } } }
	endA { ap_none {  { endA in_data 0 7 } } }
}
