set C_TypeInfoList {{ 
"heapSort" : [[], {"return": [[],"0"] }, [{"ExternC" : 0}], [ {"indexOutputData": [[], {"scalar": "char"}] }],["1","2"],""],
 "1": [ "operation", [[],"3"],""],
 "2": [ "A", [[], {"array": ["0", [256]]}],""], 
"3": [ "fp_bit1", {"typedef": [[[],"4"],""]}], 
...
set portList { 
	...
	{ A_address1 sc_out sc_lv 8 signal 2 } 
	{ A_ce1 sc_out sc_logic 1 signal 2 } 
	{ A_we1 sc_out sc_logic 1 signal 2 } 
	{ A_d1 sc_out sc_lv 16 signal 2 } 
	{ A_q1 sc_in sc_lv 16 signal 2 } 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"], "CDFG" : "heapSort", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
		...
		{"Name" : "A", "Type" : "Memory", "Direction" : "IO", "BlockSignal" : [], "SubConnect" : [
			{"SubInst" : "grp_heapSort_maxHeapify_noRecurv_fu_115", "Port" : "A"}]}],
		"WaitState" : [
		{"State" : "ap_ST_st3_fsm_2", "FSM" : "ap_CS_fsm", "SubInst" : "grp_heapSort_maxHeapify_noRecurv_fu_115"},
		{"State" : "ap_ST_st8_fsm_7", "FSM" : "ap_CS_fsm", "SubInst" : "grp_heapSort_maxHeapify_noRecurv_fu_115"}],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_heapSort_maxHeapify_noRecurv_fu_115", "Parent" : "0", "Child" : [], "CDFG" : "heapSort_maxHeapify_noRecurv", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "690051"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "690052"}
]}
