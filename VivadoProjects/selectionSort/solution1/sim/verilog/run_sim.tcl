...
if {[file isfile selectionSort.autotvin.dat]} {
	file delete -force selectionSort.autotvin.dat
}

if {[file isfile selectionSort.autotvout.dat]} {
	file delete -force selectionSort.autotvout.dat
}
