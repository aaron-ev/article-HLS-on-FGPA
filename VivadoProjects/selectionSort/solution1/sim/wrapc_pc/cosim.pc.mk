...
$(ObjDir)/selectionSort_tb.cpp_pre.cpp.tb.o : selectionSort_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling selectionSort_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/selectionSort.cpp_pre.cpp.tb.o : selectionSort.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling selectionSort.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
