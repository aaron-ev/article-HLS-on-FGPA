...
(* CORE_GENERATION_INFO="selectionSort,hls_ip_2016_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7a100tcsg324-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.854000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=145,HLS_SYN_LUT=171}" *)
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_sig_cseq_ST_st2_fsm_1)) begin
        ...
        index_min_cast1_reg_209[7 : 0] <= index_min_cast1_fu_137_p1[7 : 0];
    end
end
...
assign exitcond1_i_fu_141_p2 = ((index_min_reg_77 == ap_const_lv8_FF) ? 1'b1 : 1'b0);

assign exitcond_i_fu_164_p2 = ((j_0_in_i_reg_108 == ap_const_lv16_FF) ? 1'b1 : 1'b0);

assign i_fu_147_p2 = (index_min_reg_77 + ap_const_lv8_1);
...
always @ (posedge ap_clk) begin
    index_min_cast1_reg_209[15:8] <= 8'b00000000;
end
