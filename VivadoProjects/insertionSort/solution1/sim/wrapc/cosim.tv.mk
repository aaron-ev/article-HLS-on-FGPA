...
$(ObjDir)/insertionSort_tb.cpp_pre.cpp.tb.o : insertionSort_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling insertionSort_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/insertionSort.cpp_pre.cpp.tb.o : insertionSort.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling insertionSort.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
