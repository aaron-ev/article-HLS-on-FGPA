...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.insertionSort.autotvin_indexOutputData.dat"
         "c.insertionSort.autotvin_operation_V.dat"
         "c.insertionSort.autotvin_A.dat"
         "c.insertionSort.autotvout_A.dat"
         "c.insertionSort.autotvout_ap_return.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.insertionSort.autotvout_A.dat"
         "rtl.insertionSort.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
