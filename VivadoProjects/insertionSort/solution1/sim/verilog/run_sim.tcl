...
if {[file isfile insertionSort.autotvin.dat]} {
	file delete -force insertionSort.autotvin.dat
}

if {[file isfile insertionSort.autotvout.dat]} {
	file delete -force insertionSort.autotvout.dat
}
