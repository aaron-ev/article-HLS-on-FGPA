...
`define AUTOTB_DUT      insertionSort
`define AUTOTB_DUT_INST AESL_inst_insertionSort
`define AUTOTB_TOP      apatb_insertionSort_top
`define AUTOTB_LAT_RESULT_FILE "insertionSort.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "insertionSort.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_insertionSort_top
...
`define AUTOTB_TVIN_indexOutputData  "./c.insertionSort.autotvin_indexOutputData.dat"
`define AUTOTB_TVIN_operation_V  "./c.insertionSort.autotvin_operation_V.dat"
`define AUTOTB_TVIN_A  "./c.insertionSort.autotvin_A.dat"
`define AUTOTB_TVIN_indexOutputData_out_wrapc  "./rtl.insertionSort.autotvin_indexOutputData.dat"
`define AUTOTB_TVIN_operation_V_out_wrapc  "./rtl.insertionSort.autotvin_operation_V.dat"
`define AUTOTB_TVIN_A_out_wrapc  "./rtl.insertionSort.autotvin_A.dat"
`define AUTOTB_TVOUT_A  "./c.insertionSort.autotvout_A.dat"
`define AUTOTB_TVOUT_ap_return  "./c.insertionSort.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_A_out_wrapc  "./impl_rtl.insertionSort.autotvout_A.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.insertionSort.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 257;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 130562;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.insertionSort.autotvout_A.dat", "r");
    fp2 = $fopen("./impl_rtl.insertionSort.autotvout_A.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.insertionSort.autotvout_A.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.insertionSort.autotvout_A.dat\"!");
    else begin
        $display("Comparing rtl.insertionSort.autotvout_A.dat with impl_rtl.insertionSort.autotvout_A.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
    fp1 = $fopen("./rtl.insertionSort.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.insertionSort.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.insertionSort.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.insertionSort.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.insertionSort.autotvout_ap_return.dat with impl_rtl.insertionSort.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
