set C_TypeInfoList {{ 
"insertionSort" : [[], {"return": [[],"0"] }, [{"ExternC" : 0}], [ {"indexOutputData": [[], {"scalar": "char"}] }],["1","2"],""],
 "1": [ "operation", [[],"3"],""],
 "2": [ "A", [[], {"array": ["0", [256]]}],""], 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : [], "CDFG" : "insertionSort", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "1",
		"Port" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2", "Max" : "130562"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "130563"}
]}
