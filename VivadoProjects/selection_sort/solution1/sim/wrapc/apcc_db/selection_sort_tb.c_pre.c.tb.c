...
signed short selectionSort(signed short ,  char );
...
printf("\n  %%3 = trunc i32 %%2 to i16, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_9_count);
  llvm_cbe_tmp__2 = (unsigned short )((unsigned short )llvm_cbe_tmp__1&65535U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__2);
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = tail call signext i16 @selectionSort(i16 signext %%3, i8 signext 0) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_10_count);
   /*tail*/ selectionSort(llvm_cbe_tmp__2, ((unsigned char )0));
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%storemerge12 = phi i32 [ %%8, %%.preheader ], [ 0, %%1  for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_storemerge12_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = trunc i32 %%storemerge12 to i8, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_19_count);
  llvm_cbe_tmp__5 = (unsigned char )((unsigned char )llvm_cbe_storemerge12&255U);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = tail call signext i16 @selectionSort(i16 signext 0, i8 signext %%6) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_20_count);
   /*tail*/ selectionSort(((unsigned short )0), llvm_cbe_tmp__5);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = add nsw i32 %%storemerge12, 1, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_22_count);
