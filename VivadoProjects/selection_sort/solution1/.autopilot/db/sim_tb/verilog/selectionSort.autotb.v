...
`define AUTOTB_DUT      selectionSort
`define AUTOTB_DUT_INST AESL_inst_selectionSort
`define AUTOTB_TOP      apatb_selectionSort_top
`define AUTOTB_LAT_RESULT_FILE "selectionSort.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "selectionSort.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_selectionSort_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_dataIn 1
`define AESL_DEPTH_posOutData 1
`define AUTOTB_TVIN_dataIn  "./c.selectionSort.autotvin_dataIn.dat"
`define AUTOTB_TVIN_posOutData  "./c.selectionSort.autotvin_posOutData.dat"
`define AUTOTB_TVIN_dataIn_out_wrapc  "./rtl.selectionSort.autotvin_dataIn.dat"
`define AUTOTB_TVIN_posOutData_out_wrapc  "./rtl.selectionSort.autotvin_posOutData.dat"
`define AUTOTB_TVOUT_ap_return  "./c.selectionSort.autotvout_ap_return.dat"
`define AUTOTB_TVOUT_ap_return_out_wrapc  "./impl_rtl.selectionSort.autotvout_ap_return.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 512;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 131328;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.selectionSort.autotvout_ap_return.dat", "r");
    fp2 = $fopen("./impl_rtl.selectionSort.autotvout_ap_return.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.selectionSort.autotvout_ap_return.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.selectionSort.autotvout_ap_return.dat\"!");
    else begin
        $display("Comparing rtl.selectionSort.autotvout_ap_return.dat with impl_rtl.selectionSort.autotvout_ap_return.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
