...
if (AESL_DEBUG_TRACE)
printf("\n  tail call void @selection_sort(float* getelementptr inbounds ([48 x float]* @A, i64 0, i64 0)) nounwind, !dbg !2 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_2_count);
   /*tail*/ selection_sort((float *)((&A[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 48
#endif
])));
