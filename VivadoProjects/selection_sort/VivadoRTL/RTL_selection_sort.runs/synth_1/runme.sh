...
HD_PWD='C:/Users/aaron/Desktop/VivadoProjects/selection_sort/VivadoRTL/RTL_selection_sort.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log selection_sort.vds -m64 -mode batch -messageDb vivado.pb -notrace -source selection_sort.tcl
