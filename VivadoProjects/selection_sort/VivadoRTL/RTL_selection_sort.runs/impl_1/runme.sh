...
HD_PWD='C:/Users/aaron/Desktop/VivadoProjects/selection_sort/VivadoRTL/RTL_selection_sort.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log selection_sort.vdi -applog -m64 -messageDb vivado.pb -mode batch -source selection_sort.tcl -notrace
